...
namespace SectionVer2.Other_App.BatchPlot4
{
    public class SimplePlottingCommands
    {
        ...
        static public void WindowPlot()
        {
            ...
            acedTrans(first, rbFrom.UnmanagedObject, rbTo.UnmanagedObject, 0, out firres);

            // ... and the second
            acedTrans(second, rbFrom.UnmanagedObject, rbTo.UnmanagedObject, 0, out secres);
            ...
            using (tr)
            {
                ...
                psv.SetPlotConfigurationName(ps, "pdfFactory Pro", "A4");
